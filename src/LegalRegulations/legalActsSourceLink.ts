...
export const legalActsSourceLink = {
  ...
  celex02018R0858: {
    celexNumber: "02018R0858",
    title: "Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2018/858 z dnia 30 maja 2018 r. w sprawie homologacji i nadzoru rynku pojazdów silnikowych i ich przyczep oraz układów, komponentów i oddzielnych zespołów technicznych przeznaczonych do tych pojazdów, zmieniające rozporządzenie (WE) nr 715/2007 i (WE) nr 595/2009 oraz uchylające dyrektywę 2007/46/WE",
    sourceUrl: "http://data.europa.eu/eli/reg/2018/858/",
    lexUrl: "https://sip.lex.pl/#/act/69059567/",
    categories: [
      ...category_M.map(({ name }) => name),
      ...category_N.map(({ name }) => name),
      ...category_O.map(({ name }) => name),
  ...
  celex02013R0168: {
    celexNumber: "02013R0168",
    title: "Rozporządzenie Parlamentu Europejskiego i Rady (UE) nr 168/2013 z dnia 15 stycznia 2013 r. w sprawie homologacji i nadzoru rynku pojazdów dwu- lub trzykołowych oraz czterokołowców",
    sourceUrl: "http://data.europa.eu/eli/reg/2013/168/",
    lexUrl: "https://sip.lex.pl/#/act/68293684",
    categories: [
      ...category_L.map(({ name }) => name),
    ],
  },
