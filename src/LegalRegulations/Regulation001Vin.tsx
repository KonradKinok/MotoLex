            ...
            <div className={styles.legalProvisionsMainContainer}>
              ...
              <div className={styles.legalProvisionsContainer}>
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  <h4 className={styles.blockquoteHeader}>Preambuła (10):</h4>
                  <p className={styles.paragraph}>
                    Aby zapobiec błędom pisarskim w numerze identyfikacyjnym
                    pojazdu (VIN), należy zawrzeć w nim cyfrę kontrolną oraz
                    zdefiniować metodę obliczania tej cyfry kontrolnej.
                  </p>
                </blockquote>
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    homologacji typu UE pojazdów kategorii M, N i O oraz
                    układów, komponentów i oddzielnych zespołów technicznych
                    zgodnie z art. 4 ust. 7, art. 8 ust. 3 oraz art. 10 ust. 3
                ...
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  <h4 className={styles.blockquoteHeader}>
                    rozdział I art.2 pkt 4:
                  </h4>
                  <p className={styles.paragraph}>
                    "numer identyfikacyjny pojazdu" (VIN) oznacza alfanumeryczny
                    kod przypisany pojazdowi przez producenta w celu zapewnienia
                    właściwej identyfikacji każdego pojazdu;
                  </p>
                </blockquote>
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  <h4 className={styles.blockquoteHeader}>
                ...
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  <h4 className={styles.blockquoteHeader}>
                    załącznik II część 2 sekcja A pkt 2. Numer identyfikacyjny
                    pojazdu (VIN)
                  </h4>
                  <p className={styles.paragraph}>
                  ...
                  <p className={styles.paragraph}>
                    2.0.3. VIN umieszcza się na podwoziu lub na pojeździe w
                    momencie, gdy samochód opuszcza linię produkcyjną.
                  </p>
                  <p className={styles.paragraph}>
                    2.1. VIN musi składać się z następujących trzech członów i
                    cyfry kontrolnej: <br />
                  ...
                  <p className={styles.paragraph}>
                    2.2.1. Kod ten musi składać się z trzech znaków
                    alfanumerycznych, wielkich liter alfabetu łacińskiego lub
                    cyfr arabskich, nadanych przez właściwy organ państwa, w
                    którym znajduje się siedziba główna producenta.
                  </p>
                  <p className={styles.paragraph}>
                    2.2.2. Właściwy organ musi podejmować działania w
                    porozumieniu z organizacją międzynarodową określoną w normie
                    ISO 3780:2009 "Pojazdy drogowe. Światowy kod identyfikujący
                    producenta (WMI)".
                  </p>
                  <p className={styles.paragraph}>
                    2.2.3. Jeżeli całkowita produkcja producenta wynosi mniej
                    niż 500 pojazdów rocznie, trzecim znakiem jest zawsze "9".
                    Aby zidentyfikować takich producentów, właściwy wyżej
                    wymieniony organ, o którym mowa w pkt 2.2, musi wyznaczyć
                    też trzeci, czwarty i piąty znak VIS.
                  </p>
                  <p className={styles.paragraph}>
                    2.3. VDS musi składać się z pięciu znaków alfanumerycznych,
                    wielkich liter alfabetu łacińskiego lub cyfr arabskich,
                    które opisują ogólne cechy pojazdu. Jeżeli producent nie
                    wykorzystuje co najmniej jednego z pięciu znaków, w
                    niewykorzystane miejsca należy wstawić znaki alfanumeryczne
                    wybrane przez producenta, aby całkowita liczba wymaganych
                    znaków wynosiła pięć.
                  </p>
                  <p className={styles.paragraph}>
                    2.4. Na dziewiątej pozycji w VIN znajduje się cyfra
                    kontrolna, która jest matematycznie poprawna zgodnie ze
                    wzorem określonym w sekcji C.
                  </p>
                  <p className={styles.paragraph}>
                    2.5. VIS musi składać się z ośmiu znaków alfanumerycznych,
                    wielkich liter alfabetu łacińskiego lub cyfr arabskich, przy
                    czym cztery ostatnie znaki to wyłącznie cyfry. VIS, wraz z
                    numerami WMI i VDS, musi umożliwiać jednoznaczną
                    identyfikację danego pojazdu. W każde niewykorzystane
                    miejsce należy wstawić cyfrę "0", aby całkowita liczba
                    znaków wynosiła osiem.
                  </p>
                  <p className={styles.paragraph}>
                    2.6. Wysokość znaków w VIN umieszczonym na podwoziu nie
                    powinna być mniejsza niż 7 mm.
                  </p>
                  <p className={styles.paragraph}>
                ...
                <blockquote cite={CELEX_02021R0535.act.sourceUrl}>
                  ...
                  <p className={styles.paragraph}>
                    1. Cyfrę kontrolną określa się poprzez przeprowadzenie
                    obliczeń matematycznych określonych w pkt 1.1-1.4.
                  </p>
                  <p
                    id={`${id}-vin-values-description`}
                  ...
                  <p
                    ...
                    className={styles.paragraph}
                  >
                    1.2. Należy pomnożyć przypisaną wartość dla każdego znaku w
                    VIN przez wagę pozycji określoną poniżej:
                  </p>
                  <table
                  ...
                  <p className={styles.paragraph}>
                    1.3. Należy dodać otrzymane iloczyny i podzielić sumę przez
                    11.
                  </p>
                  <p
